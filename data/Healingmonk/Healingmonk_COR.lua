...
----------------------------------------------------------------    ------------------------- Precast Sets -------------------------
    ...
    sets.precast.CorsairRoll = {main={ name="Lanun Knife", augments={'Path: C',}},
	range="Compensator",
    ...
    legs={ name="Herculean Trousers", augments={'Mag. Acc.+15 "Mag.Atk.Bns."+15','Weapon skill damage +4%','STR+9','Mag. Acc.+9','"Mag.Atk.Bns."+15',}},
    ...
    legs="Mummu kecks +2",
    feet={ name="Herculean Boots", augments={'Accuracy+17 Attack+17','Crit.hit rate+5','Accuracy+14','Attack+14',}},
    neck="Sanctity Necklace",
    waist="Sailfi Belt",
