...
function init_gear_sets()
    ...
    sets.midcast.FastRecast = {
        head="White rarab cap +1",neck="Unmoving Collar +1",ear1="Cryptic Earring +1",ear2="Krux Earring",
        body="Kendatsuba samue +1",hands="Kendatsuba tekko +1",ring1="Petrov Ring",ring2="Defending Ring",
        back="Moonlight Cape",waist="Chaac Belt",legs="Arjuna breeches +1",feet="Amm Greaves"}
    ...
    sets.engaged.SomeAcc = {main="Dojikiri Yasutsuna",sub="Utu Grip",ammo="Aurgelmir Orb +1",
...
--[[Right now Adoulin sets are the same as non-Adoulin.
	...
	-- Weapons sets
	sets.weapons.Dojikiri = {main="Masamune",sub="Utu Grip"}
