...
function user_setup()
	...
	state.IdleMode:options('Normal','ST','Flash')
...
function init_gear_sets()
   ...
   -- sets.precast.WS['Aeolian Edge'].TH = set_combine(sets.precast.WS['Aeolian Edge'], sets.TreasureHunter)--
    ...
    hands={ name="Herculean Gloves", augments={'Accuracy+20 Attack+20','"Triple Atk."+3','AGI+2','Accuracy+14',}},
    legs={ name="Samnuha Tights", augments={'STR+10','DEX+10','"Dbl.Atk."+3','"Triple Atk."+3',}},
    feet={ name="Herculean Boots", augments={'Accuracy+17','INT+4','Quadruple Attack +2','Accuracy+2 Attack+2',}},
    neck="Anu Torque",
