...
--[[
        ...
        gs c scholar accuracy           Altruism               
...
function init_gear_sets()
	...
	oils="Silent Oil",
	crepe="Pear Crepe",
	warp="Scroll of Instant Warp",
	reraise="Scroll of Instant Reraise",
	retrace="Scroll of Instant Retrace",
    ...
    sets.precast.FC = {main="Bolelabunga",
    sub="Genmei Shield",
    ammo="Sapience Orb",
    head="Amalric Coif +1",
    body="Zendik Robe",
    ...
    sets.precast.FC.Cure = set_combine(sets.precast.FC, {body="Heka's Kalasiris",back="Pahtli Cape",ear2="Mendicant's earring"})
    ...
    sets.midcast.FastRecast = {ammo="Impatiens",
        head="Nahtirah Hat",ear2="Loquacious Earring",ear1="Etiolation Earring",neck="Voltsurge torque",
        body="Zendik robe",hands="Helios Gloves",ring1="Prolix Ring",ring2="Lebeche ring",
        back="Perimede cape",waist="Witful Belt",legs="Hagondes Pants +1",feet="Regal pumps +1"}
	...
	sets.midcast.CureWithLightWeather = {main="Raetic Rod +1",
    sub="Ammurapi Shield",
    ammo="Pemphredo Tathlum",
    head={ name="Vanya Hood", augments={'MP+50','"Fast Cast"+10','Haste+2%',}},
    body="Vedic Coat",
    ...
    sets.midcast.Regen = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ...
    sets.midcast.Stoneskin = set_combine(sets.midcast['Enhancing Magic'], {waist="Siegel Sash",neck="Nodens Gorget",legs="Doyen pants"})

    sets.midcast.Storm = set_combine(sets.midcast['Enhancing Magic'], {feet="Pedagogy Loafers"})

    sets.midcast.Protect = {ring1="Sheltered Ring",ear2="Brachyura Earring"}
    sets.midcast.Protectra = sets.midcast.Protect
	
	sets.midcast.Haste = set_combine(sets.midcast['Enhancing Magic'])

    sets.midcast.Shell = {ring1="Sheltered Ring",ear2="Brachyura Earring"}
    sets.midcast.Shellra = sets.midcast.Shell
	

    -- Custom spell classes
    sets.midcast.MndEnfeebles = {main="Akademos",sub="Enki strap",ammo="Hydrocera",
        head="Pedagogy mortarboard +3",neck="Eddy necklace",ear1="Regal Earring",ear2="Dignitary's Earring",
        body="Shango robe",hands="Jhakri cuffs +2",ring1="Kishar Ring",ring2="Sangoma Ring",
    ...
    sets.midcast['Dark Magic'] = {main="Akademos",sub="Niobid strap",ammo="Pemphredo tathlum",
        head="Pedagogy mortarboard +3",neck="Erra pendant",ear1="Regal earring",ear2="Dignitary's Earring",
        body="Shango robe",hands="Jhakri cuffs +2",ring1="Kishar Ring",ring2="Evanescence Ring",
        back="Lugh's Cape",waist="Luminary sash",legs="Chironic hose",feet="Jhakri pigaches +2"}
	...
	sets.midcast['Noctohelix'] = {main="Akademos",sub="Niobid strap",ammo="Pemphredo Tathlum",
        head="Pedagogy mortarboard +3",neck="Saevus pendant +1",ear1="Barkarole Earring",ear2="Friomisi Earring",
        body="Amalric doublet +1",hands="Amalric gages +1",ring1="Shiva Ring +1",ring2="Shiva Ring +1",
        back="Lugh's Cape",waist=gear.ElementalObi,legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','Magic burst dmg.+5%','"Mag.Atk.Bns."+13',}},feet="Arbatel loafers +1"}
		
	--Storm Sets
	
	sets.midcast.Storm = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
    head={ name="Telchine Cap", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
    body={ name="Telchine Chas.", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
	...
	sets.midcast['Firestorm II'] = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
    head={ name="Telchine Cap", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
    body={ name="Telchine Chas.", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
	...
	sets.midcast['Hailstorm II'] = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
    head={ name="Telchine Cap", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
    body={ name="Telchine Chas.", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
	...
	sets.midcast['Rainstorm II'] = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
    head={ name="Telchine Cap", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
    body={ name="Telchine Chas.", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
	...
	sets.midcast['Thunderstorm II'] = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
    head={ name="Telchine Cap", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
    body={ name="Telchine Chas.", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
	...
	sets.midcast['Windstorm II'] = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
    head={ name="Telchine Cap", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
    body={ name="Telchine Chas.", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
	...
	sets.midcast['Sandstorm II'] = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
    head={ name="Telchine Cap", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
    body={ name="Telchine Chas.", augments={'Mag. Evasion+25','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
	...
	sets.midcast['Aurorastorm II'] = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
	...
	sets.midcast['Voidstorm II'] = {main={ name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+19',}},
    sub="Ammurapi Shield",
    ammo="Staunch Tathlum +1",
    head={ name="Telchine Cap", augments={'Mag. Evasion+24','"Conserve MP"+5','Enh. Mag. eff. dur. +9',}},
    body={ name="Telchine Chas.", augments={'Mag. Evasion+19','"Conserve MP"+5','Enh. Mag. eff. dur. +10',}},
    ...
    sub="Ammurapi Shield",
    ammo="Pemphredo Tathlum",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','"Occult Acumen"+4','Mag. Acc.+5','"Mag.Atk.Bns."+14',}},
    body={ name="Amalric Doublet +1", augments={'MP+80','"Mag.Atk.Bns."+25','"Fast Cast"+4',}},
    ...
    -- Custom refinements for certain nuke tier
    ...
    sets.midcast.Impact = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Dosis Tathlum",
        ...
        back="Seshaw Cape",waist="Ovate Rope",legs="Hagondes Pants",feet="Bokwus Boots"}
    ...
    sets.resting = {main="Bolelabunga",sub="Genbu's Shield",ammo="Homiliary",
        ...
        body="Witching Robe",hands="nares Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Felicitas cape", waist="Austerity Belt +1",legs="Nares Trews",feet="Regal Pumps +1"}
    ...
    sets.defense.MDT = {main=gear.Staff.PDT,sub="Achaq Grip",ammo="Incantor Stone",
        head="Nahtirah Hat",neck="Twilight Torque",ear1="Merman's Earring",ear2="Merman's Earring",
        body="Witching Robe",hands="Yaoyotl Gloves",ring1="Defending Ring",ring2="Shadow Ring",
        back="Tuilha Cape",waist="Slipor Sash",legs="Bokwus Slops",feet="Bokwus Boots"}
	...
	sets.engaged.idle = {main="Bolelabunga",
    sub="Genmei Shield",
    ammo="Vanir Battery",
    head={ name="Chironic Hat", augments={'Spell interruption rate down -4%','Attack+12','"Refresh"+2','Mag. Acc.+12 "Mag.Atk.Bns."+12',}},
    body="Shamash Robe",
    ...
    sets.buff['Penury'] = {legs="Savant's Bracers +2"}
    ...
    sets.buff.PDTSublimation = {head="Academic's Mortarboard",ear1="Savant's Earring",body="Pedagogy Gown +3"}
