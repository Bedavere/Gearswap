...
function init_gear_sets()
    ...
    feet={ name="Merlinic Crackows", augments={'Mag. Acc.+15 "Mag.Atk.Bns."+15','Pet: Accuracy+8 Pet: Rng. Acc.+8','"Refresh"+2',}},
    ...
    sets.idle = {main="Ipetam",
    sub="Genmei Shield",
    ammo="Pemphredo Tathlum",
    head={ name="Merlinic Hood", augments={'Accuracy+24','Pet: "Mag.Atk.Bns."+5','"Refresh"+2','Accuracy+5 Attack+5',}},
    body="Shamash Robe",
    hands={ name="Chironic Gloves", augments={'"Fast Cast"+2','CHR+4','"Refresh"+2','Accuracy+4 Attack+4',}},
    legs={ name="Merlinic Shalwar", augments={'"Waltz" potency +6%','Enmity-2','"Refresh"+2','Mag. Acc.+6 "Mag.Atk.Bns."+6',}},
    feet={ name="Merlinic Crackows", augments={'Mag. Acc.+15 "Mag.Atk.Bns."+15','Pet: Accuracy+8 Pet: Rng. Acc.+8','"Refresh"+2',}},
    neck="Loricate Torque +1",
    waist="Embla Sash",
